...
| adding or changing an HTTP route | `docs/map/objects/dashboard/api-contract.md` — three edits: the frontend client, the controller, and a row in [docs/api.md](docs/api.md). `RouteContractTest` and `ApiDocCoverageTest` fail if you miss one |
