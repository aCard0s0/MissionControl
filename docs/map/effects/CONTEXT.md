...
| anything named `provider` or `model` | [models/CONTEXT.md](../objects/models/CONTEXT.md) | four different nouns. `/api/model-providers` is inference endpoints; the `model_providers` table is too. |
