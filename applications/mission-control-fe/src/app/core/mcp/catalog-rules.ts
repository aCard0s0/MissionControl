import { McpCatalogServer, McpHealthcheck, McpNamedVolume } from '../models';
...
/** States the backend reports for an entry that is not doing anything. */
const SETTLED_OPERATIONS = ['', 'idle', 'none', 'error', 'failed', 'complete', 'completed'];
